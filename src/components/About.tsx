...
// Imagen de perfil importada vía Vite para evitar dependencia de /public
...
import iconCertificate from '../assets/img/icon-certificate.svg'
...
export function About() {
  ...
  <div className="about-left">
          <a href={profileImg} target="_blank" rel="noopener noreferrer" aria-label="Abrir imagen de perfil en nueva pestaña">
            <div className="profile-frame" style={{width:'120px',height:'120px',borderRadius:'50%',overflow:'hidden',display:'inline-block'}}>
              <img
                src={profileImg}
                alt="Foto de perfil"
                style={{width:'100%',height:'100%',objectFit:'cover',objectPosition:'center',boxShadow:'0 4px 24px rgba(37,99,235,0.12)',marginBottom:'8px'}}
                onError={(e)=>{ (e.currentTarget as HTMLImageElement).src = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><rect width="100%" height="100%" fill="%23e5e7eb"/></svg>' }}
              />
            </div>
          </a>
          ...
          <div style={{marginTop:'16px',textAlign:'center'}}>
            ...
            <div style={{marginTop:'18px',textAlign:'center'}}>
              <a href="/assets/img/Scrum%20Master%20Professional%20Certification%20.pdf" target="_blank" rel="noopener noreferrer" className="badge" style={{display:'inline-flex',alignItems:'center',gap:'8px',background:'var(--accent)',color:'#fff',borderRadius:'18px',padding:'6px 16px',fontWeight:600,textDecoration:'none',boxShadow:'0 2px 8px rgba(37,99,235,0.10)'}}>
                <img src={iconCertificate} alt="Certificado Scrum Master" className="icon-inline" style={{width:'22px',height:'22px'}} />
              ...
              <a href="/assets/img/Ethical%20Hacking%20Professional%20Certificate-Francisco-GonzalezChea.pdf" target="_blank" rel="noopener noreferrer" className="badge" style={{display:'inline-flex',alignItems:'center',gap:'8px',background:'var(--accent)',color:'#fff',borderRadius:'18px',padding:'6px 16px',fontWeight:600,textDecoration:'none',boxShadow:'0 2px 8px rgba(37,99,235,0.10)',marginTop:'8px'}}>
                <img src={iconCertificate} alt="Certificado Ethical Hacking" className="icon-inline" style={{width:'22px',height:'22px'}} />
  ...
  <div style={{margin:'32px auto 0 auto', maxWidth:'900px', display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(220px, 1fr))', gap:'20px', justifyContent:'center'}}>
        <div className="card">
          <h3><img src={iconTerminal} alt="Stack" style={{width:'22px',verticalAlign:'middle',marginRight:'8px'}} /> Stack principal</h3>
          <p>Python, JavaScript, HTML, React, SQL, PLSQL</p>
        </div>
        <div className="card">
          <h3><img src={iconBriefcase} alt="Proyectos" style={{width:'22px',verticalAlign:'middle',marginRight:'8px'}} /> Proyectos</h3>
          <p>10+ desarrollados en la universidad (frontend y backend)</p>
        </div>
        <div className="card">
          <h3><img src={iconCalendar} alt="Experiencia" style={{width:'22px',verticalAlign:'middle',marginRight:'8px'}} /> Experiencia</h3>
          <p>2 años de formación universitaria</p>
        </div>
        <div className="card">
          <h3><img src={iconCertificate} alt="Certificados" style={{width:'22px',verticalAlign:'middle',marginRight:'8px'}} /> Certificados</h3>
